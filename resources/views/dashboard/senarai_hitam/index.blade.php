...
@section('title', 'Senarai Hitam')
@section('page-title', 'Dashboard Senarai Hitam')
...
<div class="dashboard-container">
    ...
    <div class="section-header">
        <h5 class="section-title">Status Senarai Hitam</h5>
    </div>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($blackListStats['baru']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($blackListStats['dalam_proses']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($blackListStats['selesai']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="section-header">
        <h5 class="section-title">Status Pemutihan</h5>
    </div>
    <div class="row align-items-stretch g-4">
        <!-- Left Stats -->
        <div class="col-md-6 mb-4">
            <div class="dashboard-card h-800">
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Baru</div>
                            <div class="card-value">{{ number_format($whiteListStats['baru']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Dalam Proses</div>
                            <div class="card-value">{{ number_format($whiteListStats['dalam_proses']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Selesai</div>
                            <div class="card-value">{{ number_format($whiteListStats['selesai']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
    ...
    new Chart(document.getElementById('userChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    {{ $blackListStats['baru'] }},
                    {{ $blackListStats['dalam_proses'] }},
                    {{ $blackListStats['selesai'] }}
                ],
    ...
    new Chart(document.getElementById('unitChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    {{ $whiteListStats['baru'] }},
                    {{ $whiteListStats['dalam_proses'] }},
                    {{ $whiteListStats['selesai'] }}
                ],
                backgroundColor: ['#4361ee', '#3f37c9', '#4895ef'],
                borderWidth: 0
            }]
