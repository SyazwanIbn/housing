...
@section('title', 'Lanjut Tempoh')
@section('page-title', 'Dashboard Lanjut Tempoh')
...
<div class="dashboard-container">
    ...
    <div class="section-header">
        <h5 class="section-title">Jumlah Sewa Tamat</h5>
    </div>
            ...
            <div class="dashboard-card h-800">
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Dalam Tempoh 6 Bulan</div>
                            <div class="card-value">{{ number_format($tamatSewaStats['tamat_6_bulan']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Dalam Tempoh 3 Bulan</div>
                            <div class="card-value">{{ number_format($tamatSewaStats['tamat_3_bulan']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Dalam Tempoh 1 Bulan</div>
                            <div class="card-value">{{ number_format($tamatSewaStats['tamat_1_bulan']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        <i class="fas fa-user-check icon-badge"></i>
                        <div>
                            <div class="card-title">Telah Tamat Tempoh</div>
                            <div class="card-value">{{ number_format($tamatSewaStats['tamat']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="section-header">
        <h5 class="section-title">Aliran Proses Lanjut Tempoh</h5>
    </div>
    <div class="row align-items-stretch g-4">
        <!-- Left Stats -->
        <div class="col-md-6 mb-4">
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($prosesStats['permohonan_baru']) }}</div>
                        </div>
                    </div>
                </a>
...
<script>
    new Chart(document.getElementById('userChart').getContext('2d'), {
        type: 'doughnut',
        data: {
            labels: ['Tamat 6 Bulan', 'Tamat 3 Bulan', 'Tamat 1 Bulan','Tamat Tempoh'],
            datasets: [{
                data: [
                    {{ $tamatSewaStats['tamat_6_bulan'] }},
                    {{ $tamatSewaStats['tamat_3_bulan'] }},
                    {{ $tamatSewaStats['tamat_1_bulan'] }},
                    {{ $tamatSewaStats['tamat'] }}
                ],
                backgroundColor: ['#4361ee', '#3f37c9', '#4895ef','#f1a208'],
                borderWidth: 0
            }]
        },
        options: {
    ...
    new Chart(document.getElementById('unitChart').getContext('2d'), {
        type: 'bar',
        data: {
            labels: ['Permohonan Baru', 'Mesyuarat Aktif', 'Jumlah Tawaran', 'Senarai Perjanjian'],
            datasets: [{
                data: [
                    {{ $prosesStats['permohonan_baru'] }},
