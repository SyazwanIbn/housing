...
@section('page-title', 'Dashboard Master Data')
...
<div class="dashboard-container">
    <!-- Section: Maklumat Pengguna -->
    <div class="section-header">
        <h5 class="section-title">Maklumat Pengguna</h5>
    </div>
            ...
            <div class="dashboard-card h-800">
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Penghuni</div>
                            <div class="card-value">{{ number_format($userStats['total_residents']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Penyewa</div>
                            <div class="card-value">{{ number_format($userStats['total_tenants']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Pembeli</div>
                            <div class="card-value">{{ number_format($userStats['total_buyers']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <!-- Section: Maklumat Unit -->
    <div class="section-header">
        <h5 class="section-title">Maklumat Unit</h5>
    </div>
    <div class="row align-items-stretch g-4">
        <!-- Left Stats -->
        <div class="col-md-6 mb-4">
            <div class="dashboard-card h-800">
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Keseluruhan Unit</div>
                            <div class="card-value">{{ number_format($unitStats['total_units']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Unit Disewa</div>
                            <div class="card-value">{{ number_format($unitStats['rented_units']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Unit Dijual</div>
                            <div class="card-value">{{ number_format($unitStats['sold_units']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Jumlah Unit Kosong</div>
                            <div class="card-value">{{ number_format($unitStats['vacant_units']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
...
<script>
    new Chart(document.getElementById('userChart').getContext('2d'), {
        type: 'doughnut',
        data: {
            labels: ['Penghuni', 'Penyewa', 'Pembeli'],
            datasets: [{
                data: [
                    {{ $userStats['total_residents'] }},
                    {{ $userStats['total_tenants'] }},
                    {{ $userStats['total_buyers'] }}
                ],
    ...
    new Chart(document.getElementById('unitChart').getContext('2d'), {
        type: 'doughnut',
        data: {
            labels: ['Disewa', 'Dijual', 'Kosong'],
            datasets: [{
                data: [
                    {{ $unitStats['rented_units'] }},
                    {{ $unitStats['sold_units'] }},
                    {{ $unitStats['vacant_units'] }}
                ],
                backgroundColor: ['#e63946', '#f1a208', '#a8dadc'],
                borderWidth: 0
            }]
        },
        options: {
