...
@section('title', 'Tukar Nama')
@section('page-title', 'Dashboard Tukar Nama')
...
<div class="dashboard-container">
    ...
    <div class="section-header">
        <h5 class="section-title">Status Permohonan</h5>
    </div>
    ...
    <div class="section-header">
        <h5 class="section-title">Aliran Proses Tukar Nama</h5>
    </div>
    <div class="row align-items-stretch g-4">
        <!-- Left Stats -->
        <div class="col-md-6 mb-4">
