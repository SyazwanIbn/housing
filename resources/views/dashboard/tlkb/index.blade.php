...
@section('title', 'TLKB')
@section('page-title', 'Dashboard TLKB')
...
<div class="dashboard-container">
    ...
    <div class="section-header">
        <h5 class="section-title">Status Petak Parking</h5>
    </div>
            ...
            <div class="dashboard-card h-800">
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            <div class="card-title">Baru</div>
                            <div class="card-value">{{ number_format($parkingStats['parking_disewa']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($parkingStats['parking_kosong']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($parkingStats['parking_diselenggara']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="section-header">
        <h5 class="section-title">Status Permohonan Petak Parking</h5>
    </div>
    <div class="row align-items-stretch g-4">
        <!-- Left Stats -->
        <div class="col-md-6 mb-4">
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($permohonanStats['keseluruhan']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($permohonanStats['baru']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($permohonanStats['dalam_proses']) }}</div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="card-link card-link-hover">
                    <div class="card-row">
                        ...
                        <div>
                            ...
                            <div class="card-value">{{ number_format($permohonanStats['selesai']) }}</div>
                        </div>
                    </div>
                </a>
            </div>
...
<script>
    new Chart(document.getElementById('userChart').getContext('2d'), {
        type: 'doughnut',
        data: {
            labels: ['Parking Disewa', 'Parking Kosong', 'Parking Diselenggara'],
            datasets: [{
                data: [
                    {{ $parkingStats['parking_disewa'] }},
                    {{ $parkingStats['parking_kosong'] }},
                    {{ $parkingStats['parking_diselenggara'] }}
                ],
    ...
    new Chart(document.getElementById('unitChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    {{ $permohonanStats['keseluruhan'] }},
                    {{ $permohonanStats['baru'] }},
                    {{ $permohonanStats['dalam_proses'] }},
